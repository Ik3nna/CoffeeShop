const BeansData = [
  {
    ...
    imagelink_square: require('../assets/images/coffee-images/robusta_coffee_beans/robusta_coffee_beans_square.png'),
    imagelink_portrait: require('../assets/images/coffee-images/robusta_coffee_beans/robusta_coffee_beans_portrait.png'),
    ingredients: 'Africa',
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: require('../assets/images/coffee-images/arabica_coffee_beans/arabica_coffee_beans_square.png'),
    imagelink_portrait: require('../assets/images/coffee-images/arabica_coffee_beans/arabica_coffee_beans_portrait.png'),
    ingredients: 'Africa',
    special_ingredient: 'From Africa',
    prices: [
      {size: '250gm', price: '5.50', currency: '$'},
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: require('../assets/images/coffee-images/liberica_coffee_beans/liberica_coffee_beans_square.png'),
    imagelink_portrait: require('../assets/images/coffee-images/liberica_coffee_beans/liberica_coffee_beans_portrait.png'),
    ingredients: 'Africa',
    special_ingredient: 'From Africa',
    prices: [
      {size: '250gm', price: '5.50', currency: '$'},
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: require('../assets/images/coffee-images/excelsa_coffee_beans/excelsa_coffee_beans_square.png'),
    imagelink_portrait: require('../assets/images/coffee-images/excelsa_coffee_beans/excelsa_coffee_beans_portrait.png'),
    ingredients: 'Africa',
    special_ingredient: 'From Africa',
    prices: [
      {size: '250gm', price: '5.50', currency: '$'},
